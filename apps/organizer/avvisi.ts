...
if (ev && !hasModule(ev.organizationId, 'M-Broadcast')) {
  document.querySelector('main')!.innerHTML =
    `<div class="pf-card"><h2>🔒 Avvisi — richiede Pro</h2><p class="pf-muted">Con il piano Free non puoi pubblicare avvisi al pubblico.</p><a class="pf-btn pf-btn--primary" href="/apps/organizer/abbonamento.html">Passa a Pro</a></div>`
} else {
