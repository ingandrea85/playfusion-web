...
const ctx = { client: {} as any, orgId: 'o', e3BaseUrl: 'https://x', navigate: () => {}, refresh: () => {}, isPlatformAdmin: false, orgRole: 'OWNER', entitlements: entitlements('CLUB') } satisfies ViewCtx
