...
async function boot() {
  try {
    ...
    new HashRouter()
      ...
      .on('#/org/finals-formats/new', () => route(finalsFormatEditorScreen, {}))
      .on('#/org/finals-formats/:id', (p) => route(finalsFormatEditorScreen, p))
      .on('#/org/finals-formats', () => route(finalsFormatsScreen, {}))
