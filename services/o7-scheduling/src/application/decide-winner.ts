...
/** `restrictToCategory` (S25): a director may only decree on their own category's match. */
export interface DecideWinnerInput { sportEventId: string; matchId: string; winner: 'HOME' | 'AWAY'; restrictToCategory?: string }
