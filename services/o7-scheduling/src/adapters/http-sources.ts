...
export class HttpEventSource implements EventSource {
  ...
  async get(sportEventId: string): Promise<EventView | undefined> {
    ...
    return { sportEventId: e.sportEventId, dates: e.dates, categorie: e.categorie ?? [], gironi: e.gironi, sport: e.sport, tieBreak: e.tieBreak, finalsType: e.finalsType, qualifiersPerGroup: e.qualifiersPerGroup };
  }
}
