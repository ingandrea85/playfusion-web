...
export const ColorBorderDefault = "#d9e2ec";
export const ColorBorderStrong = "#cbd5e1";
export const ColorStatusFinished = "#64748b";
export const ColorHeroGradientFrom = "#eef4ff";
export const ColorHeroGradientTo = "#fff2e8";
export const ColorTertiary = "#f4f7fb";
