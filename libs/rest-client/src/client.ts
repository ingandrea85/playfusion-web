...
export interface Client { o2: O2Api; o3: O3Api; o4: O4Api; o5: O5Api; o12: O12Api; o7: O7Api; o9: O9Api }
...
export function createClient(cfg: HttpConfig): Client {
  return { o2: o2(cfg), o3: o3(cfg), o4: o4(cfg), o5: o5(cfg), o12: o12(cfg), o7: o7(cfg), o9: o9(cfg) }
}
